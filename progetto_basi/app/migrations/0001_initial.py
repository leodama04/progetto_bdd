# Generated by Django 5.2.3 on 2025-06-13 15:14
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Evento',
            fields=[
                ('codice_evento', models.CharField(editable=False, max_length=10, primary_key=True, serialize=False, unique=True)),
                ('nome', models.CharField(max_length=100)),
                ('descrizione', models.TextField(blank=True, null=True)),
                ('data', models.DateField()),
                ('ora_inizio', models.TimeField(blank=True, null=True)),
                ('ora_fine', models.TimeField(blank=True, null=True)),
                ('tipo', models.CharField(choices=[('pubblico', 'Pubblico'), ('privato', 'Privato')], default='pubblico', editable=False, max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ruolo', models.CharField(choices=[('A', 'Amministratore'), ('C', 'Cliente')], max_length=1)),
